...
function professionalPlanningPrompt(
  ...
  return [
    ...
    "Select desktop-app-debug when the user asks Termes to create or change an app and run it on an Account-owned Desktop Connector, inspect console stacks, connect to browser DevTools, or request a Windows Visual Studio debugger handoff.",
